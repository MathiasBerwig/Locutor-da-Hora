...
namespace Locutor_da_Hora.Converters
{
    ...
    /// Retorna Visibility.Visible caso todos os booleanos informados sejam True e a primeira Locucao.UniqueName seja diferente de GerenciadorLocucoes.ADICIONAR_LOCUCAO. Caso contrário, Visibility.Hidden.
    /// </summary>
    ...
    {       
                            ...
                            System.Globalization.CultureInfo culture)
        {
            ...
            return visible && !locucao.UniqueName.Equals(GerenciadorLocucoes.ADICIONAR_LOCUCAO) && (!locucao.ReadOnly || App.DebugMode) ? System.Windows.Visibility.Visible : System.Windows.Visibility.Hidden;
        }
